...
var encodedData = require('soop').load('Pandacore/util/EncodedData', {
  base58: base58
});
var versionedData = require('soop').load('Pandacore/util/VersionedData', {
  parent: encodedData
});

var Address = require('soop').load('Pandacore/lib/Address', {
